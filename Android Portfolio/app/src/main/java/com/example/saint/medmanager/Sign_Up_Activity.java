...
public class Sign_Up_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleApiClient = new GoogleApiClient.Builder(Sign_Up_Activity.this)
                .enableAutoManage(Sign_Up_Activity.this , new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
...
// Passing Google Api Client into Intent.
    ...
    public void FirebaseUserAuth(GoogleSignInAccount googleSignInAccount) {
        ...
        Toast.makeText(Sign_Up_Activity.this,""+ authCredential.getProvider(),Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(Sign_Up_Activity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> AuthResultTask) {
                        ...
                        if (AuthResultTask.isSuccessful()){
                            ...
                            Toast.makeText(Sign_Up_Activity.this,"Google Sign in Successful",Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(Sign_Up_Activity.this,"Something Went Wrong",Toast.LENGTH_LONG).show();
        ...
        mAuthentication.createUserWithEmailAndPassword(emailSignUp, passwordSignUp).
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Sign_Up_Activity.this, "Registration Successful.",
                    ...
                    Toast.makeText(Sign_Up_Activity.this, "Registration failed, Existing Email Address.",
                            Toast.LENGTH_SHORT).show();
